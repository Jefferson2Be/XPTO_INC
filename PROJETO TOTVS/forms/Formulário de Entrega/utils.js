...
const utils = {
    ...
    isEmpty: (value = '') => {
        return value == '' || value == undefined || value == "undefined" || value == null || value == "null" || value.length <= 0 || value == '0,00' || value == '0,0000' || value == '&nbsp;' || value == []
    },
    setVlrUS: (value = '0,00') => {
        ...
        $('#' + vlrCampo).on('blur', function () {
            ...
            if (valor) {
                ...
                if (dataDigitada < hoje) {
                    utils.toast('Data inválida: ', 'A data selecionada não pode ser inferior que a atual.', 'warning')
